...
def extract_features(design_file, yosys_binary='yosys', abc_binary='abc'):
    ...
    # To adapt to the gym environment, percentage is round to integer
    features['percentage_of_ands'] = int(round(features['percentage_of_ands']*1000))
    features['percentage_of_ors'] = int(round(features['percentage_of_ors']*1000))
    features['percentage_of_nots'] = int(round(features['percentage_of_nots']*1000))
